        ...
        <ul>
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="{{ asset('frontend/assets/images/tab_2.jpg') }}" alt="product"
            ...
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="{{ asset('frontend/assets/images/pro4.jpg') }}" alt="product"
                            class="img-fluid w-100"></a>
                    <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                </div>
                <div class="wsus__cart_text">
            ...
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="{{ asset('frontend/assets/images/pro2.jpg') }}" alt="product"
                            class="img-fluid w-100"></a>
                    <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                </div>
                <div class="wsus__cart_text">
            ...
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="{{ asset('frontend/assets/images/pro9.jpg') }}" alt="product"
                            class="img-fluid w-100"></a>
                    <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                </div>
                <div class="wsus__cart_text">
