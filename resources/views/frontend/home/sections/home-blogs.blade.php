    ...
    <div class="container">
        ...
        <div class="row home_blog_slider">
            <div class="col-xl-3">
                <div class="wsus__single_blog wsus__single_blog_2">
                    <a class="wsus__blog_img" href="#">
                        <img src="{{ asset('frontend/assets/images/blog_1.jpg') }}" alt="blog"
            ...
            <div class="col-xl-3">
                <div class="wsus__single_blog wsus__single_blog_2">
                    <a class="wsus__blog_img" href="#">
                        <img src="{{ asset('frontend/assets/images/blog_2.jpg') }}" alt="blog"
                            class="img-fluid w-100">
                    </a>
                    <div class="wsus__blog_text">
            ...
            <div class="col-xl-3">
                <div class="wsus__single_blog wsus__single_blog_2">
                    <a class="wsus__blog_img" href="#">
                        <img src="{{ asset('frontend/assets/images/blog_3.jpg') }}" alt="blog"
                            class="img-fluid w-100">
                    </a>
                    <div class="wsus__blog_text">
            ...
            <div class="col-xl-3">
                <div class="wsus__single_blog wsus__single_blog_2">
                    <a class="wsus__blog_img" href="#">
                        <img src="{{ asset('frontend/assets/images/blog_4.jpg') }}" alt="blog"
                            class="img-fluid w-100">
                    </a>
                    <div class="wsus__blog_text">
            ...
            <div class="col-xl-3">
                <div class="wsus__single_blog wsus__single_blog_2">
                    <a class="wsus__blog_img" href="#">
                        <img src="{{ asset('frontend/assets/images/blog_5.jpg') }}" alt="blog"
                            class="img-fluid w-100">
                    </a>
                    <div class="wsus__blog_text">
