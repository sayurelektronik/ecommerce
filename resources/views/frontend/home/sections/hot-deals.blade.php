    ...
    <div class="container">
        ...
        <div class="row hot_deals_slider_2">
            <div class="col-xl-4 col-lg-6">
                <div class="wsus__hot_deals_offer">
                    <div class="wsus__hot_deals_img">
                        <img src="{{ asset('frontend/assets/images/pro0010.jpg') }}" alt="mobile"
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="wsus__hot_deals_offer">
                    <div class="wsus__hot_deals_img">
                        <img src="{{ asset('frontend/assets/images/pro0011.jpg') }}" alt="mobile"
                            class="img-fluid w-100">
                    </div>
                    <div class="wsus__hot_deals_text">
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="wsus__hot_deals_offer">
                    <div class="wsus__hot_deals_img">
                        <img src="{{ asset('frontend/assets/images/pro0012.jpg') }}" alt="mobile"
                            class="img-fluid w-100">
                    </div>
                    <div class="wsus__hot_deals_text">
                        <a class="wsus__hot_title" href="product_details.html">apple smart watch</a>
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="wsus__hot_deals_offer">
                    <div class="wsus__hot_deals_img">
                        <img src="{{ asset('frontend/assets/images/pro0013.jpg') }}" alt="mobile"
                            class="img-fluid w-100">
                    </div>
                    <div class="wsus__hot_deals_text">
                        <a class="wsus__hot_title" href="product_details.html">portable mobile Speaker</a>
        ...
        <div class="wsus__hot_large_item">
            ...
            <div class="row grid2">
                <div class="col-xl-3 col-sm-6 col-md-4 col-lg-4 clotha spka wata">
                    <div class="wsus__product_item">
                        ...
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/charger_2.jpg') }}" alt="product"
                                class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/charger_1.jpg') }}" alt="product"
                ...
                <div class="col-xl-3 col-sm-6 col-md-4 col-lg-4 eleca cama">
                    <div class="wsus__product_item">
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/headphone_1.jpg') }}" alt="product"
                                class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/headphone_2.jpg') }}" alt="product"
                                class="img-fluid w-100 img_2" />
                        </a>
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                ...
                <div class="col-xl-3 col-sm-6 col-md-4 col-lg-4 clotha spka cama wata">
                    <div class="wsus__product_item">
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/tab_1.jpg') }}" alt="product"
                                class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/tab_2.jpg') }}" alt="product"
                                class="img-fluid w-100 img_2" />
                        </a>
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                ...
                <div class="col-xl-3 col-sm-6 col-md-4 col-lg-4 clotha eleca cama">
                    <div class="wsus__product_item">
                        <span class="wsus__minus">-20%</span>
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/mobile_1.jpg') }}" alt="product"
                                class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/mobile_2.jpg') }}" alt="product"
                                class="img-fluid w-100 img_2" />
                        </a>
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
        ...
        <div class="wsus__hot_small_item wsus__hot_small_item_2">
            <div class="row">
                ...
                <div class="col-xl-2 col-6 col-sm-6 col-md-4 col-lg-3">
                    <a class="wsus__hot_deals__single" href="#">
                        <div class="wsus__hot_deals__single_img">
                            <img src="{{ asset('frontend/assets/images/pro9_9.jpg') }}" alt="bag"
                                class="img-fluid w-100">
                        </div>
                        <div class="wsus__hot_deals__single_text">
                            <h5>men's sholder bag</h5>
                ...
                <div class="col-xl-2 col-6 col-sm-6 col-md-4 col-lg-3">
                    <a class="wsus__hot_deals__single" href="#">
                        <div class="wsus__hot_deals__single_img">
                            <img src="{{ asset('frontend/assets/images/pro10.jpg') }}" alt="bag"
                                class="img-fluid w-100">
                        </div>
                        <div class="wsus__hot_deals__single_text">
                ...
                <div class="col-xl-2 col-6 col-sm-6 col-md-4 col-lg-3">
                    <a class="wsus__hot_deals__single" href="#">
                        <div class="wsus__hot_deals__single_img">
                            <img src="{{ asset('frontend/assets/images/pro2.jpg') }}" alt="bag"
                                class="img-fluid w-100">
                        </div>
                        <div class="wsus__hot_deals__single_text">
                            <h5>men's shoes</h5>
