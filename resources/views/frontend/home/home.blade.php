...
@section('content')
                                    ...
                                    <div class="row modal_slider">
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('frontend/assets/images/zoom1.jpg') }}" alt="product"
                                                    class="img-fluid w-100">
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('frontend/assets/images/zoom2.jpg') }}" alt="product"
                                                    class="img-fluid w-100">
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('frontend/assets/images/zoom3.jpg') }}" alt="product"
                                                    class="img-fluid w-100">
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('frontend/assets/images/zoom4.jpg') }}" alt="product"
                                                    class="img-fluid w-100">
                                            </div>
                                        </div>
                                    </div>
    ...
    <!--============================
        ...
        ==============================-->
    @include('frontend.home.sections.slider-one-product')
    <!--============================
            ELECTRONIC PART END
        ==============================-->
    ...
    <!--============================
            ELECTRONIC PART START
        ==============================-->
    @include('frontend.home.sections.slider-two-product')
    <!--============================
            ELECTRONIC PART END
        ==============================-->
    ...
    <!--============================
            LARGE BANNER  START
        ==============================-->
    @include('frontend.home.sections.banner-large')
    <!--============================
            LARGE BANNER  END
        ==============================-->
    ...
    <!--============================
        ...
        ==============================-->
    @include('frontend.home.sections.weekly')
    <!--============================
