            ...
            <ul>
                <li>
                    <div class="wsus__cart_img">
                        <a href="#"><img src="{{ asset('frontend/assets/images/tab_2.jpg')}}" alt="product" class="img-fluid w-100"></a>
                ...
                <li>
                    <div class="wsus__cart_img">
                        <a href="#"><img src="{{ asset('frontend/assets/images/pro4.jpg')}}" alt="product" class="img-fluid w-100"></a>
                        <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                    </div>
                    <div class="wsus__cart_text">
                ...
                <li>
                    <div class="wsus__cart_img">
                        <a href="#"><img src="{{ asset('frontend/assets/images/pro2.jpg')}}" alt="product" class="img-fluid w-100"></a>
                        <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                    </div>
                    <div class="wsus__cart_text">
                ...
                <li>
                    <div class="wsus__cart_img">
                        <a href="#"><img src="{{ asset('frontend/assets/images/pro9.jpg')}}" alt="product" class="img-fluid w-100"></a>
                        <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                    </div>
                    <div class="wsus__cart_text">
                                    ...
                                    <div class="row modal_slider">
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('frontend/assets/images/zoom1.jpg')}}" alt="product" class="img-fluid w-100">
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('frontend/assets/images/zoom2.jpg')}}" alt="product" class="img-fluid w-100">
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('frontend/assets/images/zoom3.jpg')}}" alt="product" class="img-fluid w-100">
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('frontend/assets/images/zoom4.jpg')}}" alt="product" class="img-fluid w-100">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row flash_sell_slider">
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__product_item">
                        ...
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/pro3.jpg')}}" alt="product" class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/pro3_3.jpg')}}" alt="product" class="img-fluid w-100 img_2" />
                        </a>
                ...
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__product_item">
                        <span class="wsus__new">New</span>
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/pro4.jpg')}}" alt="product" class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/pro4_4.jpg')}}" alt="product" class="img-fluid w-100 img_2" />
                        </a>
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__product_item">
                        <span class="wsus__minus">-20%</span>
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/pro9.jpg')}}" alt="product" class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/pro9_9.jpg')}}" alt="product" class="img-fluid w-100 img_2" />
                        </a>
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__product_item">
                        ...
                        <span class="wsus__minus">-20%</span>
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/pro2.jpg')}}" alt="product" class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/pro2_2.jpg')}}" alt="product" class="img-fluid w-100 img_2" />
                        </a>
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="row grid">
                        <div class="col-xl-2 col-6 col-sm-6 col-md-4 col-lg-3  elec cam wat">
                            <a class="wsus__hot_deals__single" href="#">
                                <div class="wsus__hot_deals__single_img">
                                    <img src="{{ asset('frontend/assets/images/pro8_8.jpg')}}" alt="bag" class="img-fluid w-100">
                                </div>
                        ...
                        <div class="col-xl-2 col-6 col-sm-6 col-md-4 col-lg-3  cloth spk">
                            <a class="wsus__hot_deals__single" href="#">
                                <div class="wsus__hot_deals__single_img">
                                    <img src="{{ asset('frontend/assets/images/pro9_9.jpg')}}" alt="bag" class="img-fluid w-100">
                                </div>
                                <div class="wsus__hot_deals__single_text">
                                    <h5>men's sholder bag</h5>
                                    <p class="wsus__rating">
                        ...
                        <div class="col-xl-2 col-6 col-sm-6 col-md-4 col-lg-3  elec cam">
                            <a class="wsus__hot_deals__single" href="#">
                                <div class="wsus__hot_deals__single_img">
                                    <img src="{{ asset('frontend/assets/images/pro10.jpg')}}" alt="bag" class="img-fluid w-100">
                                </div>
                                <div class="wsus__hot_deals__single_text">
                        ...
                        <div class="col-xl-2 col-6 col-sm-6 col-md-4 col-lg-3  cloth cam wat">
                            <a class="wsus__hot_deals__single" href="#">
                                <div class="wsus__hot_deals__single_img">
                                    <img src="{{ asset('frontend/assets/images/pro2.jpg')}}" alt="bag" class="img-fluid w-100">
                                </div>
                                <div class="wsus__hot_deals__single_text">
                                    <h5>men's shoes</h5>
                                    <p class="wsus__rating">
                ...
                <div class="row brand_slider">
                    <div class="col-xl-2">
                        <div class="wsus__brand_logo">
                            <img src="{{ asset('frontend/assets/images/brand_logo_1.jpg')}}" alt="brand" class="img-fluid w-100">
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="wsus__brand_logo">
                            <img src="{{ asset('frontend/assets/images/brand_logo_2.jpg')}}" alt="brand" class="img-fluid w-100">
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="wsus__brand_logo">
                            <img src="{{ asset('frontend/assets/images/brand_logo_3.jpg')}}" alt="brand" class="img-fluid w-100">
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="wsus__brand_logo">
                            <img src="{{ asset('frontend/assets/images/brand_logo_4.jpg')}}" alt="brand" class="img-fluid w-100">
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="wsus__brand_logo">
                            <img src="{{ asset('frontend/assets/images/brand_logo_5.jpg')}}" alt="brand" class="img-fluid w-100">
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="wsus__brand_logo">
                            <img src="{{ asset('frontend/assets/images/brand_logo_6.jpg')}}" alt="brand" class="img-fluid w-100">
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="wsus__brand_logo">
            ...
            <div class="wsus__hot_large_item">
                ...
                <div class="row grid2">
                    ...
                    <div class="col-xl-3 col-sm-6 col-md-4 col-lg-4 eleca cama">
                        <div class="wsus__product_item">
                            <a class="wsus__pro_link" href="product_details.html">
                                <img src="{{ asset('frontend/assets/images/headphone_1.jpg')}}" alt="product" class="img-fluid w-100 img_1" />
                                <img src="{{ asset('frontend/assets/images/headphone_2.jpg')}}" alt="product" class="img-fluid w-100 img_2" />
                            </a>
                            <ul class="wsus__single_pro_icon">
                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                            class="far fa-eye"></i></a></li>
                    ...
                    <div class="col-xl-3 col-sm-6 col-md-4 col-lg-4 clotha spka cama wata">
                        <div class="wsus__product_item">
                            <a class="wsus__pro_link" href="product_details.html">
                                <img src="{{ asset('frontend/assets/images/tab_1.jpg')}}" alt="product" class="img-fluid w-100 img_1" />
                                <img src="{{ asset('frontend/assets/images/tab_2.jpg')}}" alt="product" class="img-fluid w-100 img_2" />
                            </a>
                            <ul class="wsus__single_pro_icon">
                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                            class="far fa-eye"></i></a></li>
            ...
            <div class="row flash_sell_slider">
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__product_item">
                        ...
                        <span class="wsus__minus">-20%</span>
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/pro8.jpg')}}" alt="product" class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/pro8_8.jpg')}}" alt="product" class="img-fluid w-100 img_2" />
                        </a>
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__product_item">
                        <span class="wsus__minus">-20%</span>
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/kids_1.jpg')}}" alt="product" class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/kids_2.jpg')}}" alt="product" class="img-fluid w-100 img_2" />
                        </a>
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__product_item">
                        <span class="wsus__new">New</span>
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/blazer_1.jpg')}}" alt="product" class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/blazer_2.jpg')}}" alt="product" class="img-fluid w-100 img_2" />
                        </a>
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__product_item">
                        <span class="wsus__minus">-20%</span>
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{ asset('frontend/assets/images/wemans_2.jpg')}}" alt="product" class="img-fluid w-100 img_1" />
                            <img src="{{ asset('frontend/assets/images/wemans_1.jpg')}}" alt="product" class="img-fluid w-100 img_2" />
                        </a>
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-6 col-sm-6">
                    ...
                    <div class="row weekly_best2">
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <a class="wsus__hot_deals__single" href="#">
                                <div class="wsus__hot_deals__single_img">
                                    <img src="{{ asset('frontend/assets/images/pro3.jpg')}}" alt="bag" class="img-fluid w-100">
                                </div>
                                <div class="wsus__hot_deals__single_text">
        ...
        <div class="container">
            ...
            <div class="row home_blog_slider">
                ...
                <div class="col-xl-3">
                    <div class="wsus__single_blog wsus__single_blog_2">
                        <a class="wsus__blog_img" href="#">
                            <img src="{{ asset('frontend/assets/images/blog_4.jpg')}}" alt="blog" class="img-fluid w-100">
                        </a>
                        <div class="wsus__blog_text">
                ...
                <div class="col-xl-3">
                    <div class="wsus__single_blog wsus__single_blog_2">
                        <a class="wsus__blog_img" href="#">
                            <img src="{{ asset('frontend/assets/images/blog_5.jpg')}}" alt="blog" class="img-fluid w-100">
                        </a>
                        <div class="wsus__blog_text">
