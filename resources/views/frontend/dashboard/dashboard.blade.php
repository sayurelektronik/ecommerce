                                    ...
                                    <div class="wsus__message">
                                        ...
                                        <div class="wsus__message_single">
                                            <div class="wsus__message_img">
                                                <img src="{{ asset('frontend/assets/images/ts-1.jpg') }}" alt="img">
                                            </div>
                                        ...
                                        <div class="wsus__message_single">
                                            <div class="wsus__message_img">
                                                <img src="{{ asset('frontend/assets/images/ts-2.jpg') }}" alt="img">
                                            </div>
                                            <div class="wsus__message_text">
                                                <h6>susan singh</h6>
                                        ...
                                        <div class="wsus__message_single">
                                            <div class="wsus__message_img">
                                                <img src="{{ asset('frontend/assets/images/ts-3.jpg') }}" alt="img">
                                            </div>
                                            <div class="wsus__message_text">
                                                <h6>Mary Smith</h6>
