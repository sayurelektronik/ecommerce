                                ...
                                <div class="wsus__login">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="wsus__login_input">
                                            ...
                                            <input type="email" id="email" value="{{ old('email') }}" placeholder="Email" name="email">
                                        </div>
                                        <div class="wsus__login_input">
                                        ...
                                        <div class="wsus__login_save">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" id="remember_me" name="remember">
